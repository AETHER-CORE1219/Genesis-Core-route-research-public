<!-- GitHub renders this file as the repository landing page. Relative links intentionally use ../ to reach the repository root. -->

# GenesisCore Social-Expression Research

English landing page | [日本語の研究概要](../README.md)
